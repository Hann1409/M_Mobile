...
public class AsyncTaskActivity extends AppCompatActivity {
    ...
    private void drawButtonRealTime() {
        ...
        // nếu ta gọi task.execute(n1,n2,n3) thì doInBackGround nhận 1 mảng có 3 phần tử là n1,n2,n3
    }
    ...
    class MyDrawButtonTask extends AsyncTask<Integer, Integer, Double> {
        ...
        protected void onPostExecute(Double aDouble) {
            ...
            builder.setMessage("Giá trị trung bình = " + aDouble);
            builder.create().show();
        }
        ...
        protected Double doInBackground(Integer... integers) {
            ...
            for (int i = 1; i <= n; i++) {
                ...
                //đẩy dữ liệu qua onProgressUpdate để vô giao diện thời gian thực:
                publishProgress(percent, value); // thứ tự truyền dữ liệu do ta quyết định
