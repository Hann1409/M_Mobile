...
public class OrdersDetailAdapter extends ArrayAdapter<OrderDetail> {

    Activity context;
    int resource;

    public OrdersDetailAdapter(@NonNull Context context, int resource) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (detail != null) {
            ...
            txtPrice.setText(String.format("%.2f VND", detail.getPrice()));
            txtDiscount.setText(String.format("%.2f%%", detail.getDiscount()));
            txtTotal.setText(String.format("%.2f VND", detail.getTotalValue()));
        }
